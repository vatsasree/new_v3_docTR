...
parser.add_argument("--pathd", 
            ...
            type=str, default="/data3/sreevatsa/merged2/merged_newdata2")
parser.add_argument("--pathg", 
            help="Path to ground truth", 
            type=str, default='/data3/sreevatsa/merged2/merged_newdata2_json.json')
parser.add_argument("--paths", 
            help="Path to save files", 
            type=str, default='/data3/sreevatsa/reclists')
...
for c,directory in tqdm(enumerate(dirs)):
    ...
    jsonname = f"{os.path.splitext(os.path.basename(directory))[0]}.json"
...
file_path = os.path.join(dir_path, "image_recall_list" + res +".json")
