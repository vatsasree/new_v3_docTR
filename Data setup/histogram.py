...
parser.add_argument("--pathlf", 
            help="Path to reclist", 
            type=str, default='/data3/sreevatsa/reclists/image_recall_list_202401125432.json')
...
print(f'path to reclists ={path_to_reclistf}')
...
# print(len(recalls))
# print(recalls)
# plt.hist(recalls,alpha=.6, bins = 20, label = 'recalls sorted, orginal model')

plt.hist(recalls_finetuned,alpha=.6, bins = 40, label = 'recalls sorted, finetuned model')
plt.xlabel('recall')
plt.ylabel('number of documents')
plt.title('Histogram')

plt.legend(loc="upper left")
plt.savefig('histplot_together.png')
